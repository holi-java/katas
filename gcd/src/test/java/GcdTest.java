...
public class GcdTest {
  @Test public void ones() throws Exception {
    assertThat(Gcd.signed(1, 1), equalTo(1));
  }

  @Test public void zeros() throws Exception {
    assertThat(Gcd.signed(0, 0), equalTo(0));
  }

  @Test public void oneOfTheCommonDivisor() throws Exception {
    assertThat(Gcd.signed(4, 2), equalTo(2));
    assertThat(Gcd.signed(2, 4), equalTo(2));
  }

  @Test public void ascendantInputs() throws Exception {
    assertThat(Gcd.signed(6, 4), equalTo(2));
  }

  @Test public void descendantInputs() throws Exception {
    assertThat(Gcd.signed(4, 6), equalTo(2));
  }

  @Test public void negative() throws Exception {
    assertThat(Gcd.signed(-1, 2), equalTo(-1));
    assertThat(Gcd.signed(-2, 1), equalTo(-1));
  }
